<div id="cart" class="shortcut">
 <a class="shortcut_heading" href="<?php echo $checkout; ?>" id="cart-total"><?php echo $text_items; ?></a> <!-- Changed by Tymur; was: echo $cart -->
  <div class="content">
    ...
    <div class="mini-cart-info">
      <table>
        ...
        <tr>
          ...
          <td class="remove border"><a title="<?php echo $button_remove; ?>" onclick="cart.remove('<?php echo $product['key']; ?>');"><span class="remove">x</span></a></td>
        </tr>
        <?php } ?>
