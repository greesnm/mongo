...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="testimonial" class="form-horizontal">
        ...
        <input type="text" name="description" id="input-name" value="<?php echo $name; ?>" class="form-control" />
	    </div>
	    </div>
        ...
        <input type="text" name="captcha" id="input-captcha" value="<?php echo $captcha; ?>" class="form-control" />
	    </div>
        </div>
        
        <div class="form-group">
        <div class="col-sm-6"><img src="index.php?route=tool/captcha" alt="" id="captcha" /></div>
    	<div class="col-sm-6 text-right"><a onclick="$('#testimonial').submit();" class="button"><?php echo $button_send; ?></a></div>
        </div>
